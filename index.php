...
?>
Kayýtlý bir Proje açýn
</br>
<form method="post" name="city" action="index3.php">
<select name="name" >
<option value="0" selected="selected"> Bir proje seç</option>
<?php
...
Yeni bir proje oluþturun

<form method='POST' action='index2.php'>
<p>Proje ismi: <input type="text" name="name" /></p>

<p> Mdf boyutlarý 170 x 210 - 183 x 366 - 210 x 244 - 210 x 280 </p>
<p> Sunta boyutlarý 170 x 210 -	183 x 366 -	210 x 244 -	210 x 280 -	210 x 366 -	220 x 280 -	220 x 366 </p>
<p> Tabakanýn Yükseklik ve Geniþliðini Giriniz: </p>
<p>Yükseklik: <input type="text" name="yuk" /></p>
<p>Geniþlik: <input type="text" name="gen" /></p>
</br>



<p>Ýstediðiniz boyutlarý giriniz (en x boy):</p>
